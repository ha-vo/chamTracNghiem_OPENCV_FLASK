...
img_origin = cv2.imread("/home/havo/autograding/wep-app-autograding/phieu.png")
wOrigin = img_origin.shape[1]
hOrigin = img_origin.shape[0]
...
while True:
    ...
    img_canny = cv2.Canny(img_gray,400,600)
    img2 = img.copy()
